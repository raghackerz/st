...
static char *font = "CodeNewRoman Nerd Font Mono:size=8.5:antialias=true:autohint=true";
/* Spare fonts */
static char *font2[] = {
    "SauceCodePro Nerd Font Mono:pixelsize=13:antialias=true:autohint=true",
};
